...
export default function Navbar() {
        return (
            <>
                <nav className="navbar fixed-top navbar-expand-lg navbar-dark bg-dark" style={{boxShadow: "0 2px 10px black"}}>
                    <div className="container-fluid">
                        <Link className="navbar-brand" to="/">AnotherNewsApp</Link>
